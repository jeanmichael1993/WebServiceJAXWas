 ...
 * generated in the com.professorangoti.cliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculaResponse_QNAME = new QName("http://professorangoti.com/", "calculaResponse");
    private final static QName _Calcula_QNAME = new QName("http://professorangoti.com/", "calcula");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.professorangoti.cliente
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://professorangoti.com/", name = "calculaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://professorangoti.com/", name = "calcula")
